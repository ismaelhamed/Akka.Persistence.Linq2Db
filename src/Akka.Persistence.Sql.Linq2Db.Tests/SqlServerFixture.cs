...
namespace Akka.Persistence.Sql.Linq2Db.Tests
{
    ...
    public class SqlServerFixture : IAsyncLifetime
    {
        ...
        protected string SqlServerImageName => RuntimeInformation.IsOSPlatform(OSPlatform.Windows) 
            ? "microsoft/mssql-server-windows-express" 
            : "mcr.microsoft.com/mssql/server";

        protected string SqlServerImageTag => RuntimeInformation.IsOSPlatform(OSPlatform.Windows) 
            ? "2017-latest" 
            : "2017-latest-ubuntu";
        ...
        public async Task InitializeAsync()
        {
            ...
            {
                ConnectionString = "data source=.;database=akka_persistence_tests;user id=sa;password=l0lTh1sIsOpenSource"
            };
